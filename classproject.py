class Menu():
    ...
    def __repr__(self):
        return f"The {self.name} Menu runs from {self.start_time} until {self.end_time}"
...
early_bird_menu = Menu("Early Bird", early_bird_items, 1100, 2100)
...
kids_menu = Menu("Kids", kids_items, 1700, 2100)
...
arepa = Business("Take a'Arepas ", [arepas_place])

print(basta_business.franchises[1].menus[1])